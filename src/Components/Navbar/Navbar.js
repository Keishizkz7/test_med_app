...
import './Navbar.css'; // CSSファイルをインポート

const Navbar = () => {
  const [click, setClick] = useState(false); // clickというstateとそのsetterを定義
  ...
  return (
    <nav>
      <div className="nav__logo">
        <Link to="/">
          StayHealthy 
          <svg style={{ fill: '#3685fb' }} width="26" height="26" viewBox="-1.5 0 24 24" xmlns="http://www.w3.org/2000/svg">
